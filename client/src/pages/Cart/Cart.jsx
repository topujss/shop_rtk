...
import img13 from '../../assets/images/shop/13.jpg';
                      ...
                      <td class="product-thumbnail">
                        <div class="p-relative">
                          <a href="product-default.html">
                            <figure>
                              <img src={img12} alt="product" width="300" height="338" />
                            </figure>
                          </a>
                    ...
                    <tr>
                      <td class="product-thumbnail">
                        <div class="p-relative">
                          <a href="product-default.html">
                            <figure>
                              <img src={img13} alt="product" width="300" height="338" />
                            </figure>
                          </a>
                  ...
                  <div class="cart-summary mb-4">
                    ...
                    <div class="shipping-calculator">
                      ...
                      <form class="shipping-calculator-form">
                        ...
                        <button type="submit" class="btn btn-dark btn-outline btn-rounded">
                          Update Totals
                        </button>
                      </form>
                    </div>
